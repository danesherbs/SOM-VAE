...
parser.add_argument('--output_dir', type=str, help='Directory relative which all output files are stored',
                    default='.')
parser.add_argument('--n_samples', type=int, default=2377768)
...
if normalizer_state is None:
    normalizer_state = 'decomp_onehotenc_n:{}.normalizer'.format(args.n_samples)
...
args_dict['transformer_depth'] = args.depth
