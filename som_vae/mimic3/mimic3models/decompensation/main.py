...
if normalizer_state is None:
    normalizer_state = 'decomp_ts:1.00_impute:previous_start:zero_masks:True_n:2377768.normalizer'
...
if args.mode == 'train':
    ...
    if args.deep_supervision:
        ...
        if args.small_part:
            train_nbatches = 40
            val_nbatches = 40
        train_data_gen = utils.BatchGen(train_reader, 
                                        discretizer,
                                        normalizer, 
                                        args.batch_size, 
                                        train_nbatches,
        ...
        val_data_gen = utils.BatchGen(val_reader, 
                                      discretizer,
                                      normalizer, 
                                      args.batch_size, 
                                      val_nbatches, 
    ...
    if args.deep_supervision:
        ...
        test_data_loader = common_utils.DeepSupervisionDataLoader(dataset_dir=os.path.join(args.data, 'test'),
                                                                  ...
                                                                  small_part=args.small_part)
        test_data_gen = utils.BatchGenDeepSupervision(test_data_loader, 
                                                      discretizer,
                                                      normalizer, 
                                                      args.batch_size,
                                                      args.max_seq_len,
        ...
        test_data_gen = utils.BatchGen(test_reader, 
                                       discretizer,
                                       normalizer, 
                                       args.batch_size,
                                       None, 
