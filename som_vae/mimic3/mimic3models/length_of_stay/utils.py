...
def preprocess_chunk(data, ts, discretizer, normalizer=None, max_seq_len=1200, mask_value=0.0):
...
def preprocess_chunk_time(data, ts, discretizer, normalizer=None, max_seq_len=1200, mask_value=0.0):
    ...
    def _generator(self):
        ...
        while True:
            ...
            while remaining > 0:
                ...
                Xs = preprocess_chunk(Xs, ts, self.discretizer, self.normalizer, max_seq_len=1200, mask_value=0.)
    ...
    def _generator(self):
        ...
        while True:
            ...
            while remaining > 0:
                ...
                Xs, Ts = preprocess_chunk_time(Xs, ts, self.discretizer, self.normalizer, max_seq_len=1200, mask_value=0.)
